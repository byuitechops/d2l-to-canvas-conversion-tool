...
module.exports = function (course, stepCallback) {
    ...
    try {
        ...
        function throwError(err) {
            stepCallback(new Error("uploadCourse"), course);
        }
        ...
        function getMigration(body) {
            ...
            var url = 'https://byui.instructure.com/api/v1/courses/' + variables.getCourseId() + '/content_migrations/' + course.info.migrationID;
        ...
        //get the fileName from the preparedFilepath
        var fileName = course.info.preparedFilepath.split("\\")[course.info.preparedFilepath.split("\\").length - 1];
